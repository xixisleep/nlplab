...
def sentiment(text):
    token_ids, segment_ids = tokenizer.encode(text, maxlen=maxlen)  # word encoding
...
#             model.save_weights('albert_sentiment_best_model.weights')
...
if __name__ == '__main__':
    ...
    # print('时间差：', k)
    #
    # model.load_weights('albert_sentiment_best_model.weights')
    # print(u'final test acc: %05f\n' % (evaluate(test_generator)))

else:

    model.load_weights(model_dir + '/albert_sentiment_best_model.weights')
